...
class ReboundRecyclerView(context: Context, attrs: AttributeSet? = null) :
    ...
    inner class BounceBackState : VariousState, Animator.AnimatorListener,
        ...
        private fun createBounceBackAnimator(startOffset: Float): ObjectAnimator {
            // 计算弹跳动画的持续时间
            val bounceBackDuration: Float = (abs(startOffset) / mAnimAttributes.mMaxOffset) * MAX_BOUNCE_BACK_DURATION_MS
